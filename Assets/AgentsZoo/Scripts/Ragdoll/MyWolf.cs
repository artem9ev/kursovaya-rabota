...
public class MyWolf : Agent
{
    ...
    [SerializeField] private float m_yPositionReward = 0.1f;

    private WolfJointsDriver m_jointsDriver;
    ...
    protected override void Awake()
    {
        ...
        m_jointsDriver = GetComponent<WolfJointsDriver>();
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (m_jointsDriver.spinePosition.y > 0.4f)
        {
            AddReward(m_yPositionReward * m_jointsDriver.spinePosition.y);
        }
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(m_jointsDriver.GetRelativeRotation(m_jointsDriver.joints[3].forward));
        sensor.AddObservation(m_jointsDriver.GetRelativeRotation(m_jointsDriver.joints[4].forward));
        sensor.AddObservation(m_jointsDriver.GetRelativeRotation(m_jointsDriver.joints[6].forward)); // + 24*/
